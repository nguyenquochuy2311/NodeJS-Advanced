...
// change to
const isOK =
  user.name === "Huy" && user.age > 30 && user.blog === "facebook.com";
if (isOK) {
  // todo...
}
//change to
const isOK_v2 = (user) => {
  return user.name === "Huy" && user.age > 30 && user.blog === "facebook.com";
};
...
const returnReasonPhraseCode_v2 = (code) => {
  console.log(
    reasonPhraseCode_v2.get(code) || reasonPhraseCode_v2.get("default")
  );
};
